...
async def root():
    ...
    <html>
        <head>
            ...
            <style>
                body { font-family: Times New Roman, sans-serif; max-width: 800px; margin: 0 auto; padding: 20px; }
                h1 { color: #333; }
                form { margin-top: 10px; padding: 10px; border: 1px solid #ddd; border-radius: 10px; }
                button { background-color: #4CAF50; color: white; padding: 10px 15px; border: none; border-radius: 4px; cursor: pointer; }
                button:hover { background-color: #45a049; }
                #result { margin-top: 10px; padding: 10px; border: 1px solid #ddd; border-radius: 5px; white-space: pre-wrap; }
                .loading { display: none; margin-left: 10px; }
            </style>
        </head>
        <body>
            <h1>Lab Test OCR API</h1>
            <p>Upload a lab test image to extract test results using OCR.</p>
